...
public class RestDiscountController {
    ...
    @PutMapping("/rest/discounts/update/number/{id}")
    public ResponseEntity<?> updateNumber(@PathVariable String id) {
        return ResponseEntity.ok(discountService.updateDiscountNumber(id));
    }
}
