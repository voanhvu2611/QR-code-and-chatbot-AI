...
public class DiscountServiceImpl implements DiscountService {
    ...
    @Override
    public Discount findByIdAndNumberEnough(String id) {
        return discountDAO.findByIdAndNumberGreaterThanEqual(id, 0);
    }

    @Override
    public Discount updateDiscountNumber(String id) {
