...
public class WebMainController {
    ...
    /**
     * this is link for empty and go head /nongsanviet.com
     * @return
     */
    @RequestMapping("/")
    public String main() {
        return "redirect:/nongsanviet.com";
    }
     ...
     * @throws IOException
     */
    @RequestMapping("/nongsanviet.com")
    public String index(Model model, @ModelAttribute("auth") Authority auth) throws IOException {
        try {
            String title_main = "Nông sản Việt - Nơi mua sắm những nông sản chất lượng";
     ...
     * @return
     */
    @RequestMapping("/login.nongsanviet.com")
    ...
    public String profile(Model model, @ModelAttribute("auth") Authority auth) {
        try {
            ...
            model.addAttribute("title_main", "Nông sản Việt Hồ sơ cá nhân");
